...
class FlutterHostActivity : AppCompatActivity(), FlutterHostHelper.RouteCallback {

    private lateinit var flutterView: FlutterView

    private val flutterEngine: FlutterEngine = FlutterHostHelper.instance.getFlutterEngine()
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        LogUtils.i("FlutterHostActivity", "route = $route")
        FlutterHostHelper.instance.let {
...
//        startActivity(intent)
        FlutterHostHelper.instance.routeNativeInner(nativeRoute, params)
    }
