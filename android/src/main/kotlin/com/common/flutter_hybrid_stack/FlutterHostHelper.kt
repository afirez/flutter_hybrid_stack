package com.common.flutter_hybrid_stack
...
class FlutterHostHelper {
    ...
    companion object {
        ...
        const val FLUTTER_MIX_STACK_CHANNEL = "flutter_hybrid_stack_message_channel"

        //flutter初始化成功的消息
        private const val FLUTTER_ENGINE_INIT_FINISH = "flutter_engine_init_finish"

        val instance: FlutterHostHelper by lazy(mode = LazyThreadSafetyMode.SYNCHRONIZED) {
            FlutterHostHelper()
        }
    }

    var openNativeRoute: ((nativeRoute: String, params: HashMap<String, Any>?) -> Unit)? = null
    ...
    fun routeNativeInner(nativeRoute: String, params: HashMap<String, Any>?) {
        openNativeRoute?.invoke(nativeRoute, params);
    }
